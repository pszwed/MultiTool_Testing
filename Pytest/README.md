...
Test reports are automatically generated after each workflow run using **Allure**.

🔗 **Latest report:** https://pszwed.github.io/MultiTool_Testing/

Reports are generated by GitHub Actions on every manual workflow trigger.  
Each run also uploads the report as a downloadable artifact in the Actions tab.
